...
public class DBhelper extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        db.execSQL("CREATE TABLE " +TABLE_NAME+"(id INTEGER PRIMARY KEY AUTOINCREMENT,NAME TEXT ,EMAIL TEXT,PASSWORD TEXT,LP INTEGER,TP INTEGER)");
    }
    ...
    public void updateProgress(Integer lp,String ID){
        SQLiteDatabase db = this.getWritableDatabase();
        ContentValues values= new ContentValues();
        values.put("LP",lp);
        db.update(TABLE_NAME,values,"ID=\"" + ID + "\"",new String[]{});
    }
}
